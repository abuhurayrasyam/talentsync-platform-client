...
const steps = [
  {
    icon: <FaPlusCircle className="text-5xl text-yellow-500 mx-auto mb-4" />,
    title: "Post a Task",
    description:
      "Create a task with title, budget, deadline, and description. Let freelancers know what you need.",
  },
  {
    icon: <FaSearch className="text-5xl text-yellow-500 mx-auto mb-4" />,
    title: "Browse & Bid",
    description:
      "Freelancers explore tasks, apply filters, and place bids based on their expertise and availability.",
  },
  {
    icon: <FaHandshake className="text-5xl text-yellow-500 mx-auto mb-4" />,
